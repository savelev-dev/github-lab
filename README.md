- [Problem to Be Solved](README.md#training-overview)
  * [Explanation of the Solution](README.md#solution-approach)
  * [PRE-REQUISITES](README.md#pre-requisites)
- [Creating GitHub resources](README.md#creating-github-resources)
  * [TASK 1 - Create GitHub Organization settings](README.md#task-1---create-github-organization-settings)
  * [TASK 2 - Create an organization secret](README.md#task-2---create-an-organization-secret)
  * [TASK 3 - Create teams and memberships](README.md#task-3---create-teams-and-memberships)
  * [TASK 4 - Create a security manager](README.md#task-4---create-a-security-manager)
  * [TASK 5 - Create a Private Repository](README.md#task-5---create-a-private-repository)
  ...
  * [TASK 8 - Create a Secure Public Repository](README.md#task-8---create-secure-public-repositories)
- [Working with Terraform state](README.md#working-with-terraform-state)
  * [TASK 9 - Move resources](README.md#task-9---move-resources)
  * [TASK 10 - Move state to Postgres database](README.md#task-10---move-state-to-postgres-database)
  * [TASK 11 - Import resources](README.md#task-11---import-resources)
- [Configuring GitHub Actions](README.md#configuring-github-Actions)
  * [TASK 12 - Use data discovery](README.md#task-12---use-data-discovery)
  * [TASK 13 - Configuring GitHub Action Workflow](README.md#task-13---configuring-github-action-workflow)
- [Advanced tasks](README.md#advanced-tasks)
  * [TASK 14 - Create dynamically manageable resources](README.md#task-14---create-dynamically-manageable-resources)
  * [TASK 15 - Modules](README.md#task-15---modules)
